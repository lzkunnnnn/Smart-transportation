  ...
  <div class="cardList-wrapper">
    <a-row :gutter="24">
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-one" @click="sendTitle('烟雾传感器', 'sale')">
          <div class="card-title">
            <a-space :size="8"> <svg-icon icon="sale" :size="20" /> 烟雾传感器 </a-space>
          </div>
          <div class="all-count">
      ...
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-two" @click="sendTitle('访问量', 'visit')">
          <div class="card-title">
            <a-space :size="8"> <svg-icon icon="visit" :size="20" /> 燃气数据 </a-space>
          </div>
          <div class="all-count">
      ...
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-three" @click="sendTitle('加购数', 'shopCard')">
          <div class="card-title">
            <a-space :size="8"> <svg-icon icon="shopCard" :size="20" /> 红外数据 </a-space>
          </div>
          <div class="all-count">
      ...
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-four" @click="sendTitle('支付数', 'pay')">
          <div class="card-title">
            <a-space :size="8"> <svg-icon icon="pay" :size="20" /> 消火栓数据 </a-space>
          </div>
          <div class="all-count">
